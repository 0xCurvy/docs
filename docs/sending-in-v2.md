...
![Send](./public/images/newsend1.png)

- Select token and amount and tap `Review Transaction`

![Send2](./public/images/newsend2.png)

- Tap `Confirm & Send`

![Send3](./public/images/newsend3.png)

- Detailed Insight into the Transaction Route

![Send4](./public/images/newsend4.png)

- Successful Send Confirmation, tap `Transaction Details` to see more

![Send5](./public/images/newsend5.png)

# DEMO: How to use Curvy V2

[![Demo](./public/images/demo.png)](https://x.com/0xCurvy/status/1974140829766693173)
